...
6. **Work through the [Public Exposure Readiness Checklist](./public-exposure-readiness-checklist.md)** — stricter NetworkPolicies for that specific app, image scanning, a patching cadence, DMZ-style segmentation. This guide covers the ingress path only; that checklist has the rest.
